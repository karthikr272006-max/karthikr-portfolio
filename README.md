...
The interaction tests execute `script.js` in a minimal DOM harness with reduced motion enabled. They verify startup content, mobile navigation, the About-section scroll cue, project expansion, testimonial controls and invalid contact-form feedback. They do not run the normal-motion canvas animation or replace a full browser review.
